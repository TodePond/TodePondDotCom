...
I had a few theories for how to do this. One of those theories was the [slippy mindset](https://www.tadiweb.com/) and I've been doing it ever since and *so far so good*. What it means is:
...
- The slippy mindset forces you to be adaptable. This makes it easier to bend your work into weird enough shapes to let you dabble with as many different philosophies as possible.

- The slippy mindset makes you avoid code and technology and written record altogether. That's one way of avoiding the problems that technology brings: [Just](https://www.todepond.com/wikiblogarden/better-computing/just/) avoid technology altogether.

- The slippy mindset keeps you humble. It prevents you from getting carried away with building stacks upon stacks of your own idea that would trap you emotionally. The whole point of the tadi web is to fulfill other people's ideas, not your own, and the slippy mindset keeps you focused on that. 
...
This realisation gave me a growing disdain for the entire "better computing" world, including the [now-renamed](https://feelingof.com/the-name/) "[future of coding](https://feelingof.com/)" community. Everyone there is trying to *fix tech* as some noble act. But really it's none of that: It's a social club: That's ALL it is. The future of coding community is not ever going to fix anything. If anything it'll only cause [more problems](https://www.anthropic.com/webinars/future-of-ai-coding-mcp-vs-code). And it can't even leave Slack because it sees it as a tech problem rather than a people problem, which is ironic because it's a people-centered community, not a tech one, but I guess this disconnect is exactly its problem.

The recent name change to "feeling of computing" represents a wish for this to change, but that's all it is: a wish.

<br>

I'm no saint. I was part of this problem too. In my [arroost essay](https://www.todepond.com/report/arroost/), I started to understand this (shamefully late): I wasted so much time coding coding coding something complicated when what I really needed was people and their help.
...
So, as normal, I'll leave my old project behind and move onto the next one and the new people who discover me will continue to associate me only with the one project they saw me working on at the time. Depending on when you found me you might have a different name for me. Am I the "sand guy" or the "cellular automate guy" or the "fractal guy" or the "dreamberd guy" or the "tadi web guy" or the "pastagang guy" or the whatever's next guy. Either way I'm the guy. and either way I know I'll keep moving on from one project to the next: Otherwise I'll [die](https://www.youtube.com/watch?v=60SywbNuZA8).

But hey, when I finish a project I like to finish with a final artifact or final piece or something to mark [the end](https://www.todepond.com/wikiblogarden/scrappy-fiddles/sharing/normalising/live/). And sometimes that takes even longer!
...
With the impending **death of the tadi web**, there's room for [something new](https://youtu.be/WMJ1H3Ai-qs). What will that be? Where do we go from here?

I don't know but it's certainly very interesting working at [wikipedia](https://www.wikipedia.org/) right now against the backdrop of pastagang and all its nonsense.
