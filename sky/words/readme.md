writing's so annoying because english is [just] not how my brain works i swear to god i have at least three conversations happening simultaneously up there i cant even describe it like this it doesnt do it justice sometimes i've been able to represent it with these on-off poems i write like that one in the [algorave blog post](https://www.todepond.com/wikiblogarden/scrappy-fiddles/sharing/normalising/live/) i did but its a pathetic imitation of the real thing
