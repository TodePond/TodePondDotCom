...
Of course, me and Kam were both in kahoots on this. We knew there was a need for both. Sometimes you need to let it all out and TALK. Sometimes you need to [just] get on with it and *let the jam do the talking*.
...
Yes, that's right. As we all know: [When there's a crisis, three things can happen](https://www.todepond.com/sky/crisis/)
